...
def pgd_l2(model, X, y, epsilon=1.0, alpha=0.2, num_iter = 20, device = "cuda:0", restarts = 0, version = 0):
...
def pgd_l1_topk(model, X,y, epsilon = 16, alpha = 0.05, num_iter = 20, k = 20, device = "cuda:1", restarts = 0, version = 0):
...
def pgd_linf(model, X, y, epsilon=8/255, alpha=0.01, num_iter = 20, device = "cuda:0", restarts = 0, version = 0):
